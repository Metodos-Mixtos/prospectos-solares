...
CONJUNTOS = [
    ...
    ("igac_predios", "insumos/igac_predios", config.PROJECT_ROOT / "data" / "igac",
     "igac_*.geojson", "Respuestas del FeatureServer del IGAC, por celda y capa"),
    ...
    ("capacidad_barras", "insumos/capacidad_barras", config.PROJECT_ROOT / "data" / "barras" / "upme",
     "*_Informe_cap_barra_*.pdf", "Informes de capacidad por barra de la UPME, uno por subárea"),
    ...
    ("satelital", "insumos/satelital", config.PROJECT_ROOT / "data" / "satelital",
     "sat_*.jpg", "Imagen de Esri World Imagery, un recuadro por grilla"),
]
